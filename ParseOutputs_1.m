 function [totalResults, prevDayResults] = ParseOutputs_1(totalResults, PHORUMdata, day, dEnd, totalRuntime, tic, isControlledCharging,optWindow, EVdata, dirString)
...
if modelStatus ~= 1 && modelStatus ~= 4 %1=normal completion, 2=iteration interrupt, 3=resource interrupt (time limit)
