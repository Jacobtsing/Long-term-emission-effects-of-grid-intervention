...
SUPPLYTCR2c(t)$(ord(t) gt 1) ..            loadTCR2(t) =e= sum(gTCR2, gLevel(gTCR2, t)) + TI12(t)*0.99 + TI52(t)*0.99 - TI23(t)   + windTCRact2(t) + solarTCRact2(t) + sum(sTCR2,sDischarge(sTCR2,t)-sCharge(sTCR2,t))-sum((v,a)$(ord(a) eq 2),vCharge(v,t,a)-vDischarge(v,t,a));
SUPPLYTCR3c(t)$(ord(t) gt 1) ..            loadTCR3(t) =e= sum(gTCR3, gLevel(gTCR3, t)) + TI23(t)*0.99 + TI13(t)*0.99 - TI34(t)   + windTCRact3(t) + solarTCRact3(t) + sum(sTCR3,sDischarge(sTCR3,t)-sCharge(sTCR3,t))-sum((v,a)$(ord(a) eq 3),vCharge(v,t,a)-vDischarge(v,t,a));
SUPPLYTCR4c(t)$(ord(t) gt 1) ..            loadTCR4(t) =e= sum(gTCR4, gLevel(gTCR4, t)) + TI34(t)*0.99  + windTCRact4(t) + solarTCRact4(t) + sum(sTCR4,sDischarge(sTCR4,t)-sCharge(sTCR4,t))-sum((v,a)$(ord(a) eq 4),vCharge(v,t,a)-vDischarge(v,t,a));
SUPPLYTCR5c(t)$(ord(t) gt 1) ..            loadTCR5(t) =e= sum(gTCR5, gLevel(gTCR5, t)) + TI15(t)*0.99  + windTCRact5(t) + solarTCRact5(t) - TI52(t) + sum(sTCR5,sDischarge(sTCR5,t)-sCharge(sTCR5,t))-sum((v,a)$(ord(a) eq 5),vCharge(v,t,a)-vDischarge(v,t,a));
