...
HOURLY_COSTc(t) ..   HourlyCost(t) =e= sum(g, gLevel(g, t)*(gVC(g)) + gStartupCost(g, t) + gNLC(g)*U(g,t)+gReserve(g,t)*gReserveCost(g)+gReservespin(g,t)/1000)+sum(s,2*sReserve(s,t)+sReservespin(s,t)/1000);
...
SUPPLYTCR2c(t)$(ord(t) gt 1) ..            loadTCR2(t) =e= sum(gTCR2, gLevel(gTCR2, t)) + TI12(t)*0.99 + TI52(t)*0.99 - TI23(t) + windTCRact2(t) + solarTCRact2(t) + sum(sTCR2,sDischarge(sTCR2,t)-sCharge(sTCR2,t));
SUPPLYTCR3c(t)$(ord(t) gt 1) ..            loadTCR3(t) =e= sum(gTCR3, gLevel(gTCR3, t)) + TI23(t)*0.99 + TI13(t)*0.99 - TI34(t) + windTCRact3(t) + solarTCRact3(t) + sum(sTCR3,sDischarge(sTCR3,t)-sCharge(sTCR3,t));
SUPPLYTCR4c(t)$(ord(t) gt 1) ..            loadTCR4(t) =e= sum(gTCR4, gLevel(gTCR4, t)) + TI34(t)*0.99  + windTCRact4(t) + solarTCRact4(t) + sum(sTCR4,sDischarge(sTCR4,t)-sCharge(sTCR4,t));
SUPPLYTCR5c(t)$(ord(t) gt 1) ..            loadTCR5(t) =e= sum(gTCR5, gLevel(gTCR5, t)) + TI15(t)*0.99 - TI52(t) + windTCRact5(t) + solarTCRact5(t) + sum(sTCR5,sDischarge(sTCR5,t)-sCharge(sTCR5,t));
