...
SUPPLYTCR2c(t)$(ord(t) gt 1) ..            loadTCR2(t) =e=
                                            sum(gTCR2, gLevel(gTCR2, t)) + TI12(t)*0.99 + TI52(t)*0.99 - TI23(t) +
...
SUPPLYTCR3c(t)$(ord(t) gt 1) ..            loadTCR3(t) =e=
                                            sum(gTCR3, gLevel(gTCR3, t)) + TI23(t)*0.99 + TI13(t)*0.99 - TI34(t) +
...
SUPPLYTCR4c(t)$(ord(t) gt 1) ..            loadTCR4(t) =e=
                                            sum(gTCR4, gLevel(gTCR4, t)) + TI34(t)*0.99 +
...
SUPPLYTCR5c(t)$(ord(t) gt 1) ..            loadTCR5(t) =e=
                                            sum(gTCR5, gLevel(gTCR5, t)) + TI15(t)*0.99 - TI52(t) +
