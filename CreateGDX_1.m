function CreateGDX_1(type,day, PHORUMdata, optWindow, prevDayResults, EVdata, dirString,isTransmissionConstraints,isControlledCharging,thisDir)
...
if contains( type ,'cp_1')==1
    VC = 1.1*(genData.HeatRate.*FuelPrice + genData.VarOM + (genData.UpStream+genData.CO2eqv)*0.0004535924*14.88);
else
    if contains( type ,'cp')==0
        VC = 1.1*(genData.HeatRate.*FuelPrice + genData.VarOM);
    else
        VC = 1.1*(genData.HeatRate.*FuelPrice + genData.VarOM + (genData.UpStream+genData.CO2eqv)*0.0004535924*51);
    end
end
StartupCost = genData.StartupCost;

%if isEmissionsPrice == 1
...
%Jiahui 09112022
ReserveCostGDX.name = 'gReserveCost';
ReserveCostGDX.type = 'parameter';
ReserveCostGDX.uels = gens;
ReserveCostGDX.form = 'full';
ReserveCostGDX.dim = 1;
ReserveCostGDX.val = genData.ReserveCost;
...
wgdx('GenData', gensGDX, gensTCR1GDX, gensTCR2GDX, gensTCR3GDX, gensTCR4GDX, gensTCR5GDX, InitStateGDX, InitGenGDX, OntimeGDX, DowntimeGDX, CapacityGDX, VCGDX, RampRateGDX, ReserveCostGDX, MinCapacityGDX, MinUpGDX, MinDownGDX, StartupCostGDX, NLCGDX); 
...
loadTCR1 = zeros(optWindow,1); loadTCR2 = loadTCR1; loadTCR3 = loadTCR1; loadTCR4 = loadTCR1; loadTCR5 = loadTCR1;
...
if isTransmissionConstraints == 1
...
windTCR1GDX.name = 'windTCR1';
windTCR1GDX.val = windTCR1;
windTCR1GDX.type = 'parameter';
windTCR1GDX.uels = timeVars;
windTCR1GDX.form = 'full';
windTCR1GDX.dim = 1;
 
windTCR2GDX.name = 'windTCR2';
windTCR2GDX.val = windTCR2;
windTCR2GDX.type = 'parameter';
windTCR2GDX.uels = timeVars;
windTCR2GDX.form = 'full';
windTCR2GDX.dim = 1;
 
windTCR3GDX.name = 'windTCR3';
windTCR3GDX.val = windTCR3;
windTCR3GDX.type = 'parameter';
windTCR3GDX.uels = timeVars;
windTCR3GDX.form = 'full';
windTCR3GDX.dim = 1;
 
windTCR4GDX.name = 'windTCR4';
windTCR4GDX.val = windTCR4;
windTCR4GDX.type = 'parameter';
windTCR4GDX.uels = timeVars;
windTCR4GDX.form = 'full';
windTCR4GDX.dim = 1;
 
windTCR5GDX.name = 'windTCR5';
windTCR5GDX.val = windTCR5;
windTCR5GDX.type = 'parameter';
windTCR5GDX.uels = timeVars;
windTCR5GDX.form = 'full';
windTCR5GDX.dim = 1;

solarTCR1GDX.name = 'solarTCR1';
solarTCR1GDX.val = solarTCR1;
solarTCR1GDX.type = 'parameter';
solarTCR1GDX.uels = timeVars;
solarTCR1GDX.form = 'full';
solarTCR1GDX.dim = 1;

solarTCR2GDX.name = 'solarTCR2';
solarTCR2GDX.val = solarTCR2;
solarTCR2GDX.type = 'parameter';
solarTCR2GDX.uels = timeVars;
solarTCR2GDX.form = 'full';
solarTCR2GDX.dim = 1;


solarTCR3GDX.name = 'solarTCR3';
solarTCR3GDX.val = solarTCR3;
solarTCR3GDX.type = 'parameter';
solarTCR3GDX.uels = timeVars;
solarTCR3GDX.form = 'full';
solarTCR3GDX.dim = 1;

solarTCR4GDX.name = 'solarTCR4';
solarTCR4GDX.val = solarTCR4;
solarTCR4GDX.type = 'parameter';
solarTCR4GDX.uels = timeVars;
solarTCR4GDX.form = 'full';
solarTCR4GDX.dim = 1;

solarTCR5GDX.name = 'solarTCR5';
solarTCR5GDX.val = solarTCR5;
solarTCR5GDX.type = 'parameter';
solarTCR5GDX.uels = timeVars;
solarTCR5GDX.form = 'full';
solarTCR5GDX.dim = 1;

% Create load GDX file
if isTransmissionConstraints
    wgdx('LoadData', time, loadTCR1GDX, loadTCR2GDX, loadTCR3GDX, loadTCR4GDX, loadTCR5GDX, solarTCR1GDX, solarTCR2GDX, solarTCR3GDX, solarTCR4GDX, solarTCR5GDX,windTCR1GDX, windTCR2GDX, windTCR3GDX, windTCR4GDX, windTCR5GDX, TI12maxGDX, TI13maxGDX, TI15maxGDX, TI52maxGDX, TI23maxGDX, TI34maxGDX); %loadObjective;
else
    wgdx('LoadData', time, loadTCR1GDX, loadTCR2GDX, loadTCR3GDX, loadTCR4GDX, loadTCR5GDX, solarTCR1GDX, solarTCR2GDX, solarTCR3GDX, solarTCR4GDX, solarTCR5GDX,windTCR1GDX, windTCR2GDX, windTCR3GDX, windTCR4GDX, windTCR5GDX);
end
...
%movefile('*.gdx',strcat('Cases/',dirString),'f')
end
